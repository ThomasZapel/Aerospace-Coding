...
class BookCollection {
    private:
        ...
        void addHelp(Book *,Book *);
        void inorderHelp(Book *);
        void showBookHelp(string, Book *);
        void showBooksByAuthorHelp(string, Book *);
        void showHighestRatedBooksHelp(Book *,double);
        double HighestRateHelp(Book *,double);
        int getHeightHelp(Book *);
    public:
        BookCollection();
        ~BookCollection();
